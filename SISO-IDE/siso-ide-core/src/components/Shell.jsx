...
function Shell({ selectedProject, selectedSession, isActive, terminalId, terminalName }) {
  ...
  useEffect(() => {
    ...
    // Create session key for this specific terminal instance
    const sessionKey = terminalId || selectedSession?.id || `project-${selectedProject.name}`;
