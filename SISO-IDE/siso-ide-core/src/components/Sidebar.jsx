...
import { FolderOpen, Folder, Plus, MessageSquare, Clock, ChevronDown, ChevronRight, Edit3, Check, X, Trash2, Settings, FolderPlus, RefreshCw, Sparkles, Edit2, Star, Search, BarChart3 } from 'lucide-react';
...
function Sidebar({ 
  ...
  return (
    <div className="h-full flex flex-col bg-background/95 backdrop-blur-sm border-r border-border md:select-none">
      {/* Header */}
      <div className="md:p-4 md:border-b md:border-border/50 bg-card/50">
        {/* Desktop Header */}
        <div className="hidden md:flex items-center justify-between py-2">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-xl font-bold text-foreground tracking-wide">SISO</h1>
              <p className="text-xs text-blue-600 dark:text-blue-400 leading-tight font-medium">AI Assistant</p>
            </div>
          </div>
          <div className="flex gap-2">
            ...
            <Button
              variant="default"
              size="sm"
              className="h-9 w-9 px-0 bg-gradient-to-br from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white transition-all duration-200 shadow-sm hover:shadow-md"
        ...
        <div className="md:hidden p-4 border-b border-border">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                className="w-8 h-8 rounded-md bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center active:scale-95 transition-all duration-150 shadow-sm"
                onClick={() => setShowNewProject(true)}
              >
                <FolderPlus className="w-4 h-4" />
              </button>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-blue-100 dark:bg-blue-900/30 rounded-md flex items-center justify-center">
                    <FolderPlus className="w-3 h-3 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    onClick={createNewProject}
                    disabled={!newProjectPath.trim() || creatingProject}
                    className="flex-1 h-9 text-sm rounded-md bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white active:scale-95 transition-all shadow-sm"
                  >
      ...
      {/* Projects List */}
      <ScrollArea className="flex-1 md:px-3 md:py-4 overflow-y-auto overscroll-contain bg-background/30">
                ...
                <div key={project.name} className="md:space-y-1">
                  ...
                  <div className="group md:group">
                    ...
                    <div className="md:hidden">
                      <div
                        className={cn(
                          ...
                          isSelected && "bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800/50",
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3 min-w-0 flex-1">
                            <div className={cn(
                              ...
                              isExpanded ? "bg-blue-100 dark:bg-blue-900/30" : "bg-muted"
                            )}>
                              {isExpanded ? (
                          ...
                          <div className="flex items-center gap-1">
                            {editingProject === project.name ? (
                              ...
                              <>
                                ...
                                <button
                                  className="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center active:scale-90 border border-blue-200 dark:border-blue-800/50"
                                  onClick={(e) => {
                                    e.stopPropagation();
                    ...
                    <Button
                      variant="ghost"
                      className={cn(
                        "hidden md:flex w-full justify-between p-3 h-auto font-normal hover:bg-accent/50 rounded-lg border border-transparent hover:border-border/30 transition-all duration-200",
                  ...
                  {isExpanded && (
                    <div className="ml-3 space-y-1 border-l border-border pl-3">
                            ...
                            <div className="md:hidden">
                              <div
                                className={cn(
                                  ...
                                  selectedSession?.id === session.id ? "bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800/50" :
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  <div className={cn(
                                    ...
                                    selectedSession?.id === session.id ? "bg-blue-100 dark:bg-blue-900/30" : "bg-muted/50"
                                  )}>
                                    {isCursorSession ? (
                      ...
                      <div className="md:hidden px-3 pb-2">
                        <button
                          className="w-full h-8 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white rounded-md flex items-center justify-center gap-2 font-medium text-xs active:scale-[0.98] transition-all duration-150 shadow-sm"
                          onClick={() => {
                            onProjectSelect(project);
                      ...
                      <Button
                        variant="default"
                        size="sm"
                        className="hidden md:flex w-full justify-start gap-2 mt-1 h-8 text-xs font-medium bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white transition-all duration-200 shadow-sm"
