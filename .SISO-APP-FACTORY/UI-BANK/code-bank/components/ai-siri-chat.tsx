 ...
 * 
 * A beautiful, animated voice chat interface inspired by Siri with particle effects,
 * waveform visualization, and smooth state transitions.
 * 
 * Features:
 * - Siri-style voice interface with pulse animations
 * - Real-time waveform visualization
 * - Ambient particle effects
 * - Multiple states: listening, processing, speaking
