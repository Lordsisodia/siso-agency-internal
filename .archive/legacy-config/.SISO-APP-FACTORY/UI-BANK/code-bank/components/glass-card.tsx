 ...
 * 
 * A stunning 3D glass morphism card with advanced CSS transforms and hover effects.
 * Features layered glass effects, 3D rotations, floating elements, and interactive social buttons.
 * 
 * Features:
 * - 3D perspective transforms with CSS transform-style: preserve-3d
 * - Glass morphism effect with backdrop-blur and layered transparency
 * - Hover-triggered 3D rotation (rotate3d(1,1,0,30deg))
 * - Floating circular elements with staggered animation delays
 * - Interactive social media buttons with depth transforms
 * - Custom SVG logo integration
 * - Responsive design with fixed dimensions
 * - Advanced shadow effects and transitions
 * 
 * Dependencies:
 * - lucide-react (Instagram, Twitter, Github, ChevronDown icons)
 * - Tailwind CSS (for all styling and effects)
 * 
 * Technical Details:
 * - Uses CSS 3D transforms for depth illusion
 * - Backdrop-blur for glass effect
 * - Multiple transform layers for 3D depth
 * - Staggered transition delays for animation sequence
 * - Custom CSS properties for precise positioning
 * 
 * Usage Example:
 * ```tsx
 ...
 * <GlassCard className="mx-auto my-8" />
 * 
 * // In a demo container
 * <div className="flex h-[450px] w-full items-center justify-center bg-zinc-100 dark:bg-zinc-800">
 *   <GlassCard />
 * </div>
 * ```
 * 
 ...
 * - Change social media icons in the buttons array
 * - Adjust colors and gradients
 * - Modify the floating circles configuration
 * - Replace the ULogo with your own SVG
 */
...
const ULogo = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M0,80.018A1.561,1.561,0,0,1,1.483,78.390h26.7a1.561,1.561,0,0,1,1.483,1.628v2.006a1.561,1.561,0,0,1-1.483,1.628H1.483A1.561,1.561,0,0,1,0,82.025Z" transform="translate(0 -51.963)" />
  </svg>
);
