 ...
 * 
 * An advanced task management interface designed for AI agents and project planning.
 * Features hierarchical task structure, status tracking, dependency management, and MCP tool integration.
 * 
 * Features:
 * - Hierarchical task/subtask structure with unlimited nesting
 * - Interactive status management (pending, in-progress, completed, need-help, failed)
 * - Task dependency tracking and visualization
 * - MCP (Model Context Protocol) server integration for tools
 * - Advanced Framer Motion animations with reduced motion support
 * - Apple-style smooth animations and micro-interactions
 * - Expandable/collapsible task views with staggered animations
 * - Visual connecting lines for task hierarchy
 * - Status badges with color-coded priority levels
 * - Automatic task completion when all subtasks are done
 * - Accessibility-first design with reduced motion preferences
 * 
 * Technical Features:
 ...
 * - Custom easing curves for Apple-like feel [0.2, 0.65, 0.3, 0.9]
 * - Staggered child animations for visual hierarchy
 * 
 * Dependencies:
 * - framer-motion (AnimatePresence, motion, LayoutGroup)
 * - lucide-react (CheckCircle2, Circle, CircleAlert, CircleDotDashed, CircleX)
 ...
 * - Modify initial task data in initialTasks array
 * - Adjust animation timings in variants objects
 * - Change color schemes in status badge classes
 * - Add custom MCP tools in subtask.tools arrays
 * - Extend Task/Subtask interfaces for additional fields
 */
