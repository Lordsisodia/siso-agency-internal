...
export const MobileTodayCard: React.FC<MobileTodayCardProps> = ({
  ...
  const completedTasks = card.tasks?.filter(task => task.completed).length || 0;
  ...
  return (
    ...
    >
      <Card 
        className="bg-gradient-to-br from-gray-900/95 via-gray-800/80 to-gray-900/95 backdrop-blur-xl border-2 border-orange-400/30 shadow-2xl shadow-orange-500/25 relative overflow-hidden cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 hover:border-orange-400/50 hover:shadow-orange-500/30"
      ...
      >
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <div className="flex items-center justify-center space-x-2 py-3 bg-gradient-to-r from-orange-500/10 to-yellow-500/10 rounded-xl border border-orange-400/20 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-500/5 to-transparent rounded-xl"></div>
            <ChevronRight className="h-4 w-4 text-orange-400" />
            <span className="text-orange-200 font-medium text-sm">Tap card to view details</span>
            <ChevronRight className="h-4 w-4 text-orange-400" />
          </div>
          ...
          <div className="mt-3">
            <Button 
              ...
              className="w-full text-base px-6 py-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-200 rounded-xl"
            >
