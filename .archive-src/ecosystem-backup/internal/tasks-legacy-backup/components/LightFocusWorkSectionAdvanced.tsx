...
import { aiXPService, TaskAnalysis } from '@/archive/ecosystem-backup/internal/services/ai-xp-service';
        ...
        <Card className="bg-green-900/20 border-green-700/50">
          ...
          <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0 pb-24">
            ...
            <div className="mt-6 mb-4 flex justify-center">
              <Card className="bg-gradient-to-br from-gray-900/80 via-gray-800/60 to-gray-900/80 border-orange-400/30">
                <CardContent className="p-4">
                  <div className="flex flex-wrap gap-2 justify-center">
                    <button
                      className="bg-purple-500/20 border border-purple-400/50 text-purple-300 hover:bg-purple-500/30 flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg transition-all duration-200"
                      onClick={() => {
                    ...
                    <button
                      className="bg-blue-500/20 border border-blue-400/50 text-blue-300 hover:bg-blue-500/30 flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg transition-all duration-200"
                      onClick={() => {
                        console.log('Focus timer activated');
                      }}
                    >
                    ...
                    <button
                      className="bg-green-500/20 border border-green-400/50 text-green-300 hover:bg-green-500/30 flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg transition-all duration-200"
                      onClick={() => {
                        console.log('Quick photo activated');
                      }}
                    >
                    ...
                    <button
                      className="bg-gray-500/20 border border-gray-400/50 text-gray-300 hover:bg-gray-500/30 flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg transition-all duration-200"
                      onClick={() => {
                        console.log('View details activated');
                      }}
                    >
                    ...
                    <button
                      className="bg-orange-500/20 border border-orange-400/50 text-orange-300 hover:bg-orange-500/30 flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg transition-all duration-200"
                      onClick={() => {
                        const newTask: Task = {
