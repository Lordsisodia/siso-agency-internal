...
import { calculateDailyPoints, calculateRealDailyPoints, calculateWeekSummary, calculateRealWeekSummary, DailyPoints } from '@/services/gamification/dailyPointsService';
