...
import { MorningRoutineSection } from '@/archive/ecosystem-backup/internal/tasks/components/MorningRoutineSection';
import { DeepFocusWorkSection } from '@/archive/ecosystem-backup/internal/tasks/components/DeepFocusWorkSection-v2';
import { LightFocusWorkSection } from '@/archive/ecosystem-backup/internal/tasks/components/LightFocusWorkSection-v2';
import { EnhancedLightWorkManager } from '@/shared/ui/enhanced-light-work-manager';
import { HomeWorkoutSection } from '@/archive/ecosystem-backup/internal/tasks/components/HomeWorkoutSection';
import { HealthNonNegotiablesSection } from '@/archive/ecosystem-backup/internal/tasks/components/HealthNonNegotiablesSection';
import { TimeboxSection } from '@/archive/ecosystem-backup/internal/tasks/components/TimeboxSection';
import { NightlyCheckoutSection } from '@/archive/ecosystem-backup/internal/tasks/components/NightlyCheckoutSection';
import { QuickActionsSection } from '@/archive/ecosystem-backup/internal/tasks/ui/QuickActionsSection';

// Import existing tab config
import { TabId, TAB_CONFIG } from '@/archive/ecosystem-backup/internal/core/tab-config';
