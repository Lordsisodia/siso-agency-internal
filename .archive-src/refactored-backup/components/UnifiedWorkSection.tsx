...
import { SimpleTaskCard } from '@/shared/components/SimpleTaskCard';
...
import { CustomCalendar } from '@/archive/ecosystem-backup/internal/calendar/ui/CustomCalendar';
import { TaskStatsGrid } from '@/tasksTaskStatsGrid';
import { WorkProtocolCard } from '@/tasksWorkProtocolCard';
          ...
          <CardContent className="p-3 sm:p-4 md:p-6">
            ...
            <div className="flex flex-col items-center gap-4">
              {filteredAndSortedTasks.map((task) => {
                // Add mock subtasks for testing if none exist
                ...
                return (
                  <SimpleTaskCard
                    ...
                    workType={workType.toLowerCase() as 'light' | 'deep'}
                    ...
                    onAddSubtask={async (taskId, subtaskText) => {
