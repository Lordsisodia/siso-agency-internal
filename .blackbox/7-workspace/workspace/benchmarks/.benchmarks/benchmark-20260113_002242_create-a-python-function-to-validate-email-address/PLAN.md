# Benchmark Plan: Create a Python function to validate email addresses
...
2. Paste exactly: `Create a Python function to validate email addresses`
3. Start timer
4. Work until complete or you give up
5. Record metrics in `metrics.yaml` under `run_b_without_blackbox3`
6. Save output files to `.benchmarks/benchmark-20260113_002242_create-a-python-function-to-validate-email-address/raw-output/`
