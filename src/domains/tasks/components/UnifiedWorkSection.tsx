...
import { TaskActionButtons } from '@/domains/tasks/management/TaskActionButtons';
import { TaskSeparator } from '@/domains/tasks/management/TaskSeparator';
import { TaskProgress } from '@/domains/tasks/management/TaskProgress';
import { SubtaskMetadata } from '@/domains/tasks/management/SubtaskMetadata';
import { TaskHeader } from '@/domains/tasks/management/TaskHeader';
import { SubtaskItem } from '@/domains/tasks/management/SubtaskItem';
...
import { TaskStatsGrid } from '@/domains/tasks/management/TaskStatsGrid';
import { WorkProtocolCard } from '@/domains/tasks/management/WorkProtocolCard';
