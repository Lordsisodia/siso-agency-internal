...
import { INITIAL_COLUMNS } from '@/domains/admin/outreach/types';
import { LeadsTable } from '@/domains/admin/outreach/leads/LeadsTable';
import { LeadsToolbar } from '@/domains/admin/outreach/leads/LeadsToolbar';
import { LeadDetailSheet } from '@/domains/admin/outreach/LeadDetailSheet';
import { LeadsFunnelChart } from '@/domains/admin/outreach/LeadsFunnelChart';
import { OutreachAnalyticsCards } from '@/domains/admin/outreach/OutreachAnalyticsCards';
import { OutreachActivityLog } from '@/domains/admin/outreach/OutreachActivityLog';
import { AccountsGrid } from '@/domains/admin/outreach/accounts/AccountsGrid';
import { AccountManagementDialog } from '@/domains/admin/outreach/accounts/AccountManagementDialog';
import { PlatformFilters } from '@/domains/admin/outreach/accounts/PlatformFilters';
import { IndustryFilter } from '@/domains/admin/outreach/accounts/IndustryFilter';
import type { OutreachAccount } from '@/types/outreach';
import type { OutreachStats } from '@/domains/admin/outreach/types';
import {
  Table,
  TableBody,
  TableCell,
