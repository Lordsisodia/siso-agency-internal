...
1. **AdminLifeLock** (`src/domains/lifelock/_shared/shell/AdminLifeLock.tsx`)
   - Main page component
...
3. **TabLayoutWrapper** (`src/domains/lifelock/_shared/core/TabLayoutWrapper.tsx`)
...
10. **SimpleFeedbackButton** (`src/domains/feedback/SimpleFeedbackButton.tsx`)
...
From `src/domains/lifelock/_shared/shell/admin-lifelock-tabs.ts`:
...
2. **Tab Configuration:** Edit `src/domains/lifelock/_shared/shell/admin-lifelock-tabs.ts`
