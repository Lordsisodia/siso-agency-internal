        ...
        <div className="flex items-center justify-between gap-2 mb-3">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <div className="p-1.5 rounded-lg bg-rose-500/20 border border-rose-400/30 flex-shrink-0">
              <Wine className="h-4 w-4 text-rose-300" />
            </div>
            <h4 className="text-rose-100 font-semibold text-base truncate">Alcohol Tracker</h4>
          ...
          <div className="w-full bg-rose-900/30 border border-rose-600/20 rounded-full h-1.5">
            <motion.div
              className={cn(
                ...
                statusColor === 'red' && "bg-gradient-to-r from-red-400 to-rose-500"
              )}
              initial={{ width: 0 }}
                  ...
                  >
                    ...
                    <div className="flex items-end justify-between gap-1 h-24">
                      {isLoadingWeek ? (
                        ...
                        weekData.map((day) => {
                          const maxHeight = 80;
                          const height = Math.min((day.drinks / 6) * maxHeight, maxHeight);
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <p className={cn(
                          "text-sm mb-1",
                          isDryDay ? "text-green-300" : statusColor === 'yellow' ? "text-yellow-300" : statusColor === 'red' ? "text-red-300" : "text-rose-300"
                        )}>
                          Drinks Today
                        </p>
                        <motion.p
                    ...
                    <div className="flex gap-2 mt-3">
                      {[
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="flex-1 h-9 text-sm font-medium transition-all duration-200 border-purple-500/40 text-purple-300 hover:bg-purple-500/20"
                          disabled={isUpdating}
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-xs text-purple-300">Day Streak</span>
                      </div>
                      ...
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-xs text-purple-300">Best Streak</span>
                      </div>
                      ...
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-xs text-purple-300">Dry Days</span>
                      </div>
                    </div>

                    {/* Additional Stats */}
                    <div className="grid grid-cols-2 gap-3 mt-3 pt-3 border-t border-purple-700/20">
                      <div className="flex flex-col items-center gap-1">
                        <span className="text-lg font-semibold text-purple-200">{weeklyStats.average}/d</span>
                        <span className="text-xs text-purple-300">Weekly Average</span>
                      </div>
                      <div className="flex flex-col items-center gap-1">
                        <span className="text-lg font-semibold text-purple-200">{alcoholData.streakData?.totalDrinksThisMonth ?? 0}</span>
                        <span className="text-xs text-purple-300">This Month</span>
                      </div>
                    </div>

                    {/* Motivational Message */}
                    <div className="mt-3 pt-3 border-t border-purple-700/20 text-center">
