/**
 * Morning Routine Type Definitions
 * Central export point for all morning routine types
 */

import type { LucideIcon } from 'lucide-react';

// Re-export all types from this file
export * from './morning-routine';

// AI Thought Dump types
export type {
  Message,
  ThoughtDumpResult,
  ThoughtDumpContext
} from './ai-thought-dump';

// Legacy types from morning-routine.types.ts
export type {
  MorningSubtask,
  MorningTask,
  MorningHabitCategory,
  MorningHabitsByCategory,
  MorningHabitColor,
  MorningRoutineColorMap
