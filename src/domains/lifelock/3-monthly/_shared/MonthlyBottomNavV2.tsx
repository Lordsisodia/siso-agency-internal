/**
 * MonthlyBottomNavV2 Component
 *
 * Shared bottom navigation with glassmorphism effect for LifeLock monthly views.
 * Based on WeeklyBottomNavV2 pattern with purple theme for monthly.
 *
 * 3-pill navigation + More button (9-dot) as 4th pill
 * - Review (Calendar, Wins, Reflection)
 * - Goals (Monthly Goals, Performance, Projects)
 * - Habits (Consistency, Habit Grid, Analysis)
 */
...
export interface MonthlyBottomNavV2Props {
...
export const MonthlyBottomNavV2: React.FC<MonthlyBottomNavV2Props> = ({
  tabs,
  activeIndex,
  activeSubTab,
  onChange,
  ...
  // Get color based on active subsection - PURPLE THEME for Monthly
  ...
  // PURPLE THEME for Monthly view
  const tabColors = [
    'from-purple-500 to-violet-500',    // Review
    'from-violet-500 to-purple-500',    // Goals
    'from-orange-500 to-amber-500',     // Habits
  ];
