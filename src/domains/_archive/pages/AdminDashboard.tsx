...
import { StatsOverview } from '@/domains/admin/dashboard/components/StatsOverview';
import { QuickActions } from '@/domains/admin/dashboard/ui/QuickActions';
import { ClientsList } from '@/domains/admin/dashboard/components/ClientsList';
import { AdminTasks } from '@/domains/admin/dashboard/AdminTasks';
import { AdminStats } from '@/domains/admin/dashboard/components/AdminStats';
...
const ProjectBasedTaskDashboard = lazy(() => import('@/domains/admin/dashboard/components/ProjectBasedTaskDashboard'));
