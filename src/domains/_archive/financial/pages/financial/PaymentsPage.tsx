...
import { fetchInvoices, fetchInvoiceById } from '@/domains/financial/invoicesApi';
import { fetchTransactions, getFinancialSummary } from '@/domains/financial';
import { TotalCostCard } from '@/domains/admin/financials/TotalCostCard';
import { ExpensesTimeline } from '@/domains/admin/financials/ExpensesTimeline';
...
import { Invoice, FinancialTransaction } from '@/domains/financial/types';
import { PaymentsSummaryCards } from '@/domains/admin/financials/payments/PaymentsSummaryCards';
import { PaymentsHeader } from '@/domains/admin/financials/payments/PaymentsHeader';
import { PaymentMethodsSection } from '@/domains/admin/financials/payments/PaymentMethodsSection';
import { ExpenseCreditCard } from '@/domains/admin/financials/ExpenseCreditCard';
import { PaymentProgress } from '@/domains/admin/financials/payments/PaymentProgress';
import { InvoiceManagement } from '@/domains/admin/financials/payments/InvoiceManagement';
import { TokenUsageTracker } from '@/domains/admin/financials/payments/TokenUsageTracker';
