...
// Modern Task System - Clean Imports ✨
import { 
  TasksProvider,       // State management
  useTasks,           // Centralized task hook
  useTasksFilters,    // Filter management
  KanbanView,         // Modern kanban component
  CalendarView,       // Modern calendar component
  ListView,           // List view component
  TasksAI,            // AI chat component
  TaskAPI             // API operations
} from '@/tasks';
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from '@/shared/ui/resizable';
import { supabase } from '@/integrations/supabase/client';
import { useAuthSession } from '@/shared/hooks/useAuthSession';
import { useToast } from '@/shared/ui/use-toast';
// Removed scattered hooks - now using centralized useTasks from modern system
import {
  Calendar,
  Clock,
  Filter,
