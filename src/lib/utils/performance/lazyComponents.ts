...
export const LazyComponents = {
  ...
  AdminDashboard: lazy(() => import('@/domains/admin/pages/AdminDashboard')),
  AdminLifeLockDay: lazy(() => import('@/domains/admin/pages/AdminLifeLockDay')),
  AdminTaskBoard: lazy(() => import('@/domains/admin/pages/AdminTaskBoard')),
  AdminInstagramLeads: lazy(() => import('@/domains/admin/pages/AdminInstagramLeads')),
  AdminFinancialDashboard: lazy(() => import('@/domains/admin/pages/AdminFinancialDashboard')),
  AdminProjectManagement: lazy(() => import('@/domains/admin/pages/AdminProjectManagement')),
