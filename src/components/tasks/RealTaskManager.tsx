...
// import { useMainUserProject } from '@/hooks/useUserProjects'; // Commented out for now
...
export function RealTaskManager({ 
  ...
  // const { project, hasProjects } = useMainUserProject(); // Commented out for now
  const hasProjects = false; // Temporary fallback
