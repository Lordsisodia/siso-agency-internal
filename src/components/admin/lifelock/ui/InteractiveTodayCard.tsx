...
import { DeepFocusSessionCard } from './DeepFocusSessionCard';
              ...
              {taskSections.map((section, index) => {
                ...
                if (isDeepFocus && showDeepFocusSession) {
                  return (
                    ...
                    >
                      <DeepFocusSessionCard
                        tasks={lifeLockData.deepFocusTasks}
                        onSessionComplete={(session) => {
                          console.log('Session completed:', session);
                          // Here you could update the database or trigger other actions
                        }}
                        onTaskToggle={(taskId) => {
                          handleTaskToggle('deep-focus', taskId);
                        }}
                        className="w-full"
                      />
                    </motion.div>
