...
interface NightlyStatsCardProps {
  currentStreak: number;
  checkoutXP: number;
  animationDelay?: number;
}

const NightlyStatsCardComponent: React.FC<NightlyStatsCardProps> = ({
  currentStreak,
  checkoutXP,
  animationDelay = 0.3
}) => {
...
export const NightlyStatsCard = memo(NightlyStatsCardComponent);
export type { NightlyStatsCardProps };
