...
import { StatsOverview } from '@/ecosystem/internal/dashboard/components/StatsOverview';
import { QuickActions } from '@/ecosystem/internal/dashboard/ui/QuickActions';
import { ClientsList } from '@/ecosystem/internal/dashboard/components/ClientsList';
import { AdminTasks } from '@/ecosystem/internal/dashboard/components/AdminTasks';
import { AdminStats } from '@/ecosystem/internal/dashboard/components/AdminStats';
...
const ProjectBasedTaskDashboard = lazy(() => import('@/ecosystem/internal/dashboard/components/ProjectBasedTaskDashboard').then(m => ({ default: m.ProjectBasedTaskDashboard })));
