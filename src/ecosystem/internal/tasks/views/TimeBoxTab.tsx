...
import { StatisticalWeekView } from './StatisticalWeekView';
import { EnhancedTimeBoxCalendar } from '../calendar/EnhancedTimeBoxCalendar';
      ...
      >
        <Card className="bg-gradient-to-br from-purple-900/40 to-pink-900/40 border-purple-400/30">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-xs text-purple-400">Total Tasks</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-gray-900/80 via-gray-800/60 to-gray-900/80 border-blue-400/30 shadow-xl">
          <CardHeader className="pb-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-lg font-semibold text-white">Calendar & Schedule</h3>
            </div>
          </CardHeader>
          <CardContent>
