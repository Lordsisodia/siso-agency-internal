...
import { formatIndustryFocus, formatIndustryStatus } from '@/ecosystem/internal/admin/industries/utils/formatters';
import { useIndustriesList } from '@/ecosystem/internal/admin/industries/hooks/useIndustriesList';
import { INDUSTRY_FOCUS_LEVELS, INDUSTRY_STATUS_OPTIONS } from '@/ecosystem/internal/admin/industries/constants';
import type { IndustryWithMeta } from '@/ecosystem/internal/admin/industries/types/industry.types';
import { IndustryDetailSheet } from '@/ecosystem/internal/admin/industries/IndustryDetailSheet';
