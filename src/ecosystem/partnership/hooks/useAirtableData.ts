...
export interface UseAirtableDataReturn {
  ...
  // Setters
  setSelectedCell: React.Dispatch<React.SetStateAction<{ rowIndex: number; field: string } | null>>;
  setEditingCell: React.Dispatch<React.SetStateAction<{ rowIndex: number; field: string } | null>>;
}

/**
 * Custom hook for managing Airtable-style data operations
 * Handles all CRUD operations, state management, and UI interactions
 */
export function useAirtableData(): UseAirtableDataReturn {
