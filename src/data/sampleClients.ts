...
export const sampleClients: ClientData[] = [
  ...
  },
  {
    ...
    full_name: 'Dicky',
    email: null,
    business_name: 'Dickie\'s Restaurant',
    phone: null,
    avatar_url: null,
    status: 'active',
    progress: 'In Progress',
    ...
    total_steps: 10,
    completed_steps: ['planning'],
    created_at: '2025-10-18T08:19:56Z',
    updated_at: '2025-10-18T08:19:56Z',
    website_url: null,
    professional_role: 'Restaurant Owner',
    bio: 'Local restaurant owner looking to expand online presence',
    project_name: 'Dickie\'s Restaurant Website',
    company_niche: 'Restaurant & Food Service',
    development_url: null,
    mvp_build_status: 'In Progress',
    notion_plan_url: null,
    payment_status: 'Not Invoiced',
    estimated_price: null,
    initial_contact_date: '2025-10-18T00:00:00Z',
    start_date: null,
    estimated_completion_date: null,
    contact_name: 'Dicky',
    next_steps: 'Initial requirements gathering',
    priority: 'medium',
    slug: 'dickies-restaurant',
    todos: []
  }
]; 