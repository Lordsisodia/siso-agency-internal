...
export const UsageDashboard: React.FC<UsageDashboardProps> = ({ onBack }) => {
  ...
  const loadUsageStats = useCallback(async () => {
    try {
      ...
      const errorMessage = err instanceof Error && err.message.includes('No usage data available') 
        ? "No usage data yet. Start using Claude through the integrated chat to see real statistics here!"
