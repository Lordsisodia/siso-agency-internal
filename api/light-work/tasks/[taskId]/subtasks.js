/**
 * ☕ Light Work Task Subtasks API Endpoint - Vercel Serverless Function
 * 
 * HTTP API for Light Work task subtask operations
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    switch (method) {
      case 'POST':
        // POST /api/light-work/tasks/[taskId]/subtasks - Add subtask to task
        const { title } = body;
      ...
      case 'PUT':
        // PUT /api/light-work/tasks/[taskId]/subtasks - Update subtask completion
    ...
    console.error('❌ Light Work Subtasks API error:', error);
