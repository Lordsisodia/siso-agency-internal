...
const LandingPage = React.lazy(() => 
  import('@/ecosystem/landing/LandingPage').then(module => ({ default: module.LandingPage }))
);
const ClientPortal = React.lazy(() => 
  import('@/ecosystem/client/ClientPortal').then(module => ({ default: module.ClientPortal }))
);
const PartnershipPortal = React.lazy(() => 
  import('@/ecosystem/partnership/PartnershipPortal').then(module => ({ default: module.PartnershipPortal }))
);
